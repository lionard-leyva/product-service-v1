...
VALUES ('Wireless Bluetooth Headphones',
       ...
       ('Smart Watch',
        'Multifunctional smart watch with heart rate monitor and GPS.',
        199.99,
        null,
        'Standard');
...
INSERT INTO productdb.product (name, description, price, final_price, type)
VALUES ('USB Flash Drive 32GB',
        'Portable USB 3.0 flash drive with 32GB storage capacity.',
        9.99,
        null,
        'Basic'),
...
INSERT INTO productdb.product (name, description, price, final_price, type)
VALUES ('Eco-Friendly Water Bottle',
       ...
       ('Yoga Mat',
        'Non-slip yoga mat with extra thickness for comfort.',
        24.99,
        null,
        'Default');